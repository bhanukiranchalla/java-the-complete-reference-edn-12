...
class HighTemp {
    ...
    // Return true if the invoking HighTemp object has the same temperate as ht2.
...
public class InstanceMethWithObjectRefDemo {
    ...
    public static void main(String[] args) {
        ...
        HighTemp[] weekDayHighs = new HighTemp[]{   new HighTemp(89), new HighTemp(82),
        ...
        HighTemp[] weekDayHighs2 = new HighTemp[]{  new HighTemp(32), new HighTemp(12),
        ...
        // Now, use lessThanTemp() to find days when temperate was less than a specified value.
