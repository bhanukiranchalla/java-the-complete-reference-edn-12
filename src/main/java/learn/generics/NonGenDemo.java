...
// NonGen is functionally equivalent ot Gn but does not use generics.
class NonGen {
...
class NonGenDemo {
    public static void main(String[] args) {
        ...
        // Create a NonGen object and store an Integer in it. Autoboxing still occurs.
        iOb = new NonGen(88);
        ...
        // Get the value of strOb. Again, notice that cast is necessary.
